 ...
 * @author PC01017745
 */
public class MessageTypeNewDevices implements Message {

    private MessageService messageService;

    public MessageTypeNewDevices(MessageService messageService) {
    ...
    public Map<String, String> getMessageFromDatabse(SingInOutSessions singInOutSessions) {
        ...
        md.ibanc.rm.entities.Message message = messageService.findMessageByTypeAndLang("NewDevices", singInOutSessions.getCustomers().getLanguages().getShortName());
